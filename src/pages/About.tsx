        ...
        <Container size="md">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-5">
              ...
              <div style={{ ...fonts.body, color: colors.textSecondary, lineHeight: '1.9' }} className="space-y-4">
                <p>{t('about.story1')}</p>
                <p>{t('about.story2')}</p>
                <p>{t('about.story3')}</p>
              </div>
          ...
          {/* Features */}
          <div className="mt-20 grid md:grid-cols-3 gap-6 stagger-children">
            {[
              ...
              <div key={index} className="animate-fade-in-up" style={{ opacity: 0 }}>
                <Card variant={feature.variant} hover className="p-8 text-center">
                  ...
                  <p style={{ ...fonts.body, color: colors.textMuted, lineHeight: '1.8' }}>
                    {feature.desc}
                  </p>
                </Card>
              </div>
